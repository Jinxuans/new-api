...
const (
	...
	MsgAuthRefundHold            = "auth.refund_hold"
...
const (
	...
	MsgRedemptionQuotaRange        = "redemption.quota_range"
)
...
const (
	...
	MsgUserQuotaAdjustmentReasonRequired = "user.quota_adjustment_reason_required"
	MsgUserQuotaOutOfRange               = "user.quota_out_of_range"
)
